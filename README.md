...
- 📷 **Камера** — live-превью ~10 FPS, снимки JPEG с поворотом -90° и зеркалированием (сенсор физически развёрнут на плате). Сохранённый файл оптимизирован под распознавание текста: сенсор q4 + макс. резкость/контраст, перекодирование в Q_BEST 4:4:4
